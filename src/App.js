...
const renderTime = ({ remainingTime }) => {
  ...
  if (remainingTime === 0) {
    ...
    return <div className="timer-clock">{'00:00'}</div>;
  }
  return (
...
function App() {
  ...
  const handleImgClick = () => {
    ...
    if (newTimerObj[0].imgSrc === gear) {
      ...
      newTimerObj[0].buttonClass = 'timer-button';
  ...
  return (
    <main className="App">
      {timerObj.map((timerObj) => {
        return (
          <section className="timer-container" key={timerObj.key}>
            ...
            <article className="timer-content">
              <button
              ...
              <div className="timer-config-content">
                <img
                  src={minus}
